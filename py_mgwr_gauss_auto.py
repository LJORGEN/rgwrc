...
opt_bw_adap = Sel_BW(coords,Y,DV,kernel='gaussian',spherical=TF_py).search(verbose=True) #GC
...
gwr_adapt_python = GWR(coords,Y,DV,opt_bw_adap,kernel='gaussian',spherical=TF_py).fit() #GC
